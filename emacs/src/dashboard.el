...
(setq dashboard-navigator-buttons
      `(;; line1
        ((,(all-the-icons-faicon "github" :height 1.1 :v-adjust 0.0) "Homepage" "Browse homepage" (lambda (&rest _) (browse-url "https://www.github.com/satyadahal")))
	 ...
	 (,(all-the-icons-faicon "refresh" :height 0.8 :v-adjust 0.0) "Reload" "Reload-Init-File" (lambda (&rest _) (load-file "~/.emacs.d/init.el")))
        ...
        ((,(all-the-icons-faicon "linkedin" :height 1.1 :v-adjust 0.0)
          "Linkedin"
          ""
          (lambda (&rest _) (browse-url "https://np.linkedin.com/in/satya-prakash-dahal-570888190")))
	 )))

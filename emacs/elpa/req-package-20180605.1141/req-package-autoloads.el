;;; req-package-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "req-package" '("req-package"))
...
(register-definition-prefixes "req-package-args" '("req-package-"))
...
(register-definition-prefixes "req-package-cycles" '("req-package-cycles-"))
...
(register-definition-prefixes "req-package-hooks" '("add-hook-exec" "req-package-hooks-"))
